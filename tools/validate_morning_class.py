    ...
    for p in level["programs"]:
        ...
        if p["origin"] == "apk_authentic" and day in (4, 7):
            ...
            if p["origin"] == "apk_authentic":
                ...
                assert sum(len(e["sets"]) for e in working) + len(practice) <= 20
...
print(f"Morning-class checks passed: 600 named sessions, {recovery_count} early recovery classes, both new skill ladders and sampled motion contacts.")
