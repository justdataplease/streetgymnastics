...
try {
    ...
    Copy-Item -Force -LiteralPath "app\build\outputs\apk\debug\app-debug.apk" -Destination "dist\street-gymnastic-revival-debug.apk"
    ...
    $distributionFiles = @(
        "dist\street-gymnastic-revival-debug.apk",
    ...
    $apk = Get-Item -LiteralPath "dist\street-gymnastic-revival-debug.apk"
